...
INSERT INTO client
  (name, email, contact, status, created_on, updated_on)
VALUES
  ("Nitesh", "jhanitesh10@gmail.com", '9004250810', 1, NOW(), NOW()),
  ("Nikhil", "nikhil009@gmail.com", '1234567890', 1, NOW(), NOW());

  INSERT INTO project
  (client_id, project_detail, created_on, updated_on)
VALUES
  (1, "Selling phone case for my testing", NOW(), NOW()),
  (2, "Selling phone case Nickscomputer", NOW(), NOW());
-- project table
